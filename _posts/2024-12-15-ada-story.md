...
<body>
  ...
  <div id="chart2" class="chart-container">
        <iframe src="/assets/img/352_line.html" width="1300px" height=”700px" frameborder="0"></iframe>
  </div>

  <div id="chart3" class="chart-container">
        <iframe src="/assets/img/235_line.html" width="1300px" height=”700px" frameborder="0"></iframe>
  </div>

  <div id="chart4" class="chart-container">
        <iframe src="/assets/img/333_line.html" width="1300px" height=”700px" frameborder="0"></iframe>
  </div>
