...
<head>
  <style>
    ...
    .button-group {
      ...
      margin-bottom: 20px; /* 为按钮和图表之间留出间距 */
    }
    .button-group button {
      margin: 5px;
      padding: 10px;
    ...
    .chart-container {
      ...
      text-align: center; /* 确保 iframe 居中显示 */
      margin: 0 auto; /* 父容器居中 */
      position: relative; /* 避免元素漂浮 */
    }
    .chart-container.active {
      display: block; /* 只有激活的图表显示 */
    }

    /* iframe 样式 */
    iframe {
      display: block; /* 使 iframe 不受 inline 默认行为影响 */
      margin: 0 auto; /* 居中显示 */
      border: none; /* 去掉边框 */
    }
  </style>
...
<body>
  ...
  <div id="chart1" class="chart-container active">
    <iframe src="/assets/img/532_line.html" 
        width="1250px" 
        height="600px" 
        frameborder="0" 
  ...
  <div id="chart2" class="chart-container">
    <iframe src="/assets/img/235_line.html" 
        width="1250px" 
        height="600px" 
        frameborder="0" 
        sandbox="allow-same-origin allow-scripts">
  ...
  <div id="chart3" class="chart-container">
    <iframe src="/assets/img/352_line.html" 
        width="1250px" 
        height="600px" 
        frameborder="0" 
        sandbox="allow-same-origin allow-scripts">
  ...
  <div id="chart4" class="chart-container">
    <iframe src="/assets/img/333_line.html" 
        width="1250px" 
        height="600px" 
        frameborder="0" 
  ...
  <script>
    function showChart(chartId) {
      ...
      charts.forEach(chart => chart.classList.remove('active')); // 移除所有激活状态
      document.getElementById(chartId).classList.add('active'); // 激活指定图表
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      if (charts[0]) {
        charts[0].classList.add('active'); // 激活第一个图表
      }
    });
  </script>
</body>
