...
$$
PS = 0.5\frac{\ln(1+V)}{\ln(1+V_{max})} + 0.3\frac{\ln(1+L)}{\ln(1+L_{max})} + 0.2\frac{\ln(1+C)}{\ln(1+C_{max})}
$$
...
<body>
  ...
  <div id="weights 1" class="chart-container active">
      <iframe src="/assets/img/532_line.html" width="1250px" height="650px" frameborder="0" style="display: block; margin: 0 auto;"></iframe>
  </div>

  <div id="weights 2" class="chart-container">
        <iframe src="/assets/img/352_line.html" width="1250px" height="650px" frameborder="0"></iframe>
  </div>

  <div id="weights 3" class="chart-container">
        <iframe src="/assets/img/235_line.html" width="1250px" height="650px" frameborder="0"></iframe>
  </div>

  <div id="weights 4" class="chart-container">
        <iframe src="/assets/img/333_line.html" width="1250px" height="650px" frameborder="0"></iframe>
  </div>
