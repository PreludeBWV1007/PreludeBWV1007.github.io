...
<body>
  ...
  <div id="chart1" class="chart-container active">
      <iframe src="/assets/img/532_line.html" width="1000px" height="500px" frameborder="0"></iframe>
  </div>

  <div id="chart2" class="chart-container">
      <iframe src="/assets/img/352_line.html" width="1000px" height="500px" frameborder="0"></iframe>
  </div>

  <div id="chart3" class="chart-container">
      <iframe src="/assets/img/235_line.html" width="1000px" height="500px" frameborder="0"></iframe>
  </div>

  <div id="chart4" class="chart-container">
      <iframe src="/assets/img/333_line.html" width="1000px" height="500px" frameborder="0"></iframe>
  </div>
