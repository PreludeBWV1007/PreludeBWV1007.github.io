...
<body>
  ...
  <div id="chart1" class="chart-container active">
      <iframe src="/assets/img/532_line.html" width="1100px" height="600px" frameborder="0"></iframe>
  </div>

  <div id="chart2" class="chart-container">
      <iframe src="/assets/img/352_line.html" width="1100px" height="600px" frameborder="0"></iframe>
  </div>

  <div id="chart3" class="chart-container">
      <iframe src="/assets/img/235_line.html" width="1100px" height="600px" frameborder="0"></iframe>
  </div>

  <div id="chart4" class="chart-container">
      <iframe src="/assets/img/333_line.html" width="1100px" height="600px" frameborder="0"></iframe>
  </div>
...
**2005-2013 Duration 对不同 Category 的 Popular Score 的 ANOVA**
<table>
  <thead>
    <tr>
      <th>Category</th>
...
**2014-2019 Duration 对不同 Category 的 Popular Score 的 ANOVA**
<table>
  <thead>
    <tr>
      <th>Category</th>
