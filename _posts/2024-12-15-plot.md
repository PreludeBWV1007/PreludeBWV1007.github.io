...
<body>
  ...
  <div class="button-group">
    ...
    <button onclick="showChart('chart17')">Education</button>
    <button onclick="showChart('chart16')">Entertainment</button>
